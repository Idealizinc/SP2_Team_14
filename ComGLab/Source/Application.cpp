...
void Application::Init()
{
	...
	//m_window = glfwCreateWindow(1300, 975, "Computer Graphics", NULL, NULL);
	...
	m_window = glfwCreateWindow(1152, 864, "Computer Graphics", NULL, NULL); // S_Width, S_Height
